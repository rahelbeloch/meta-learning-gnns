...
conda create -y -n gnn-env-new python==3.9.5 pytorch-lightning==1.7.0 nltk==3.6.5
...
pip3 install --no-cache-dir torch==1.8.1+cu11.3 -f https://download.pytorch.org/whl/torch_stable.html

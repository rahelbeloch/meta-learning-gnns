...
SUPPORTED_MODELS = ['gat', 'prototypical', 'gmeta', 'proto-maml']
LOG_PATH = "../logs/"
...
def train(balance_data, progress_bar, model_name, seed, epochs, patience, patience_metric, h_size, top_users,
    ...
    if model_name == 'gat':
        ...
        optimizer_hparams.update(lr_val=lr, lr_decay_epochs_val=lr_decay_epochs)
    ...
    elif model_name in ['gmeta', 'proto-maml']:
